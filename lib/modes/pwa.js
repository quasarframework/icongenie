...
function getAppleLaunch (def) {
  return {
    ...
    name: 'apple-launch-{size}',
    folder: 'src/statics/icons',
    sizes: [
      [ def[0], def[1] ]
    ],
    tag: `${def[3]}\n<link rel="apple-touch-startup-image" media="${def[2]}" href="statics/icons/{name}.png">`
  }
}
...
module.exports = [
  ...
  {
    generator: 'png',
    name: 'apple-icon-{size}x{size}',
    folder: 'src/statics/icons',
    sizes: [ 120, 152, 167, 180 ]
    // tag is auto-injected by @quasar/app
    // <link rel="apple-touch-icon" sizes="{size}x{size}" href="statics/icons/{name}.png">
  },

  {
    ...
    folder: 'src/statics/icons',
    // tag is auto-injected by @quasar/app
    // <link rel="mask-icon" color="#..." href="statics/icons/{name}.svg">
  },

  {
    generator: 'png',
    name: 'ms-icon-{size}x{size}',
    folder: 'src/statics/icons',
    sizes: [ 144 ],
    // tag is auto-injected by @quasar/app
    // <meta name="msapplication-TileImage" content="statics/icons/{name}.png">
  },
